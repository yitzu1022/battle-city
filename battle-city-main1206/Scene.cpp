...
void Scene::spawnEnemy()
{
    ...
    connect(enemy, &Enemy::enemyHitsTheBrick , this , &Scene:: stopBrick ) ;
    connect(enemy, &Enemy::enemyHitsTheWall , this , &Scene:: stopWall ) ;
    connect(enemy, &Enemy::enemyHitsTheEnemy , this , &Scene:: stopEnemy ) ;
}

void Scene::stopBrick(Enemy *enemy)
{
   QPointF pos = enemy->pos();
   enemy->setPos(pos);
   enemy -> setRotation( enemy ->rotation() + 90 );
   //enemy->move();
   //delete enemy ;
}
void Scene::stopWall(Enemy *enemy)
{
   QPointF pos = enemy->pos();
   enemy->setPos(pos);
   enemy -> setRotation( enemy ->rotation() + 90 );
...
void Scene::stopEnemy(Enemy *enemy ,Enemy *otherenemy)
{
   QPointF pos = enemy->pos();
   enemy->setPos(pos);
   enemy -> setRotation( enemy ->rotation() + 90 );
  //enemy->move();
   ...
   QPointF otherpos = otherenemy->pos();
   otherenemy->setPos(otherpos);
   otherenemy -> setRotation( enemy ->rotation() + 90 );
   //otherenemy->move();
   //delete otherenemy ;
}
